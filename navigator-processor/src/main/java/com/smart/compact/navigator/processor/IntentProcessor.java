package com.smart.compact.navigator.processor;

import com.google.common.collect.ImmutableSet;
import com.smart.compact.navigator.annotation.Navigation;
...
public class IntentProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> set, RoundEnvironment roundEnvironment) {
        try {
             ...
             */
            for (Element element : roundEnvironment.getElementsAnnotatedWith(Navigation.class)) {
             ...
             */
            JavaFile.builder("com.smart.app.compact.navigator", navigatorClass.build()).build().writeTo(filer);
    ...
    public Set<String> getSupportedAnnotationTypes() {
        return ImmutableSet.of(Navigation.class.getCanonicalName());
    }
