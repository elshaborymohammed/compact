...
class ItemAdapter : CompactRecyclerView.Adapter<Item, ItemAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : CompactRecyclerView.ViewHolder<Item>(itemView) {
