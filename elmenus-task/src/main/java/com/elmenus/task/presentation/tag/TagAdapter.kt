...
open class TagAdapter : CompactRecyclerView.Adapter<Tag, RecyclerView.ViewHolder>() {
    ...
    interface OnClickListener {
        fun onClickTag(position: Int, obj: Tag)
    }
    ...
    public fun setSelectedIndex(selectedPosition: Int) {
    ...
    inner class ItemViewHolder(itemView: View) : CompactRecyclerView.ViewHolder<Tag>(itemView) {
        ...
        public override fun bind(position: Int, obj: Tag) {
            itemView.let {
                it.setOnClickListener {
                    ...
                    listener?.onClickTag(position, obj)
